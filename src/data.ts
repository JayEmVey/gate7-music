...
export const COFFEE_PAIRINGS = [
  // ── Category 1: High Energy / Fast Tempo ──────────────────────────────────
  {
    ...
    descriptionVi: 'Mạnh mẽ, sắc bén và tập trung hoàn toàn. Những bản nhạc năng lượng cao với nhịp nhanh phản chiếu cú đấm của 100% Arabica Việt Nam.',
  ...
  },
  {
    ...
    descriptionVi: 'Espresso đậm gặp cam tươi — sáng bừng, đầy sức sống. Những bản nhạc thăng hoa ở giọng trưởng với nhịp nhanh phản chiếu vị chua the mát.',
  ...
  },
  {
    ...
    descriptionVi: 'Thuần khiết, thẳng thắn, không cầu kỳ. Nhạc post-rock hay instrumental đẩy mạnh phản chiếu sự trong sáng và năng lượng tập trung của Americano.',
    tags: ['Instrumentalness > 0.50', 'Energy 0.55–0.80', 'Clean'],
    tagsVi: ['Không lời > 0.50', 'Năng lượng 0.55–0.80', 'Trong sáng'],
  },
  ...
  // ── Category 2: Acoustic / Grounded Energy ────────────────────────────────
  {
    ...
    descriptionVi: 'Thuần túy, mộc mạc, chỉ là cà phê. Tiếng guitar acoustic ngón tay hay folk chậm rãi — không màu mè, không vội vàng.',
  ...
  },
  {
    ...
    descriptionVi: 'Truyền thống, mạnh nhưng ấm áp. Nhạc cụ mộc và năng lượng đều đặn vọng lại hương vị phin nhỏ giọt cùng sữa đặc ngọt ngào.',
  ...
  },
  {
    ...
    descriptionVi: 'Bạc Xỉu nhẹ nhàng, béo mịn. Những bản acoustic thoáng đãng với năng lượng dịu dàng phản chiếu sự tươi mát của sữa tươi trên nền Robusta phin.',
    tags: ['Acousticness > 0.65', 'Energy < 0.50', 'Breezy'],
    tagsVi: ['Độ acoustic > 0.65', 'Năng lượng < 0.50', 'Thoáng đãng'],
  },
  ...
  // ── Category 3: Warm Soul / Mid Tempo ─────────────────────────────────────
  {
    ...
    descriptionVi: 'Espresso được sữa làm dịu lại — cường độ tan chảy thành mượt mà. Jazz ấm hoặc R&B nhịp trung hòa quyện hoàn hảo.',
  ...
  },
  {
    ...
    descriptionVi: 'Bọt sữa và espresso cân bằng — hơi ấm cổ điển của quán cà phê. Soul hoặc acoustic truyền thống với nhịp độ đều đặn, chào đón.',
  ...
  },
  {
    ...
    descriptionVi: 'Dịu dàng, đầy sữa, không vội vã. Neo-soul hay R&B mượt mà với groove nhẹ nhàng giữ đúng năng lượng của một ly Latte.',
    tags: ['Energy 0.40–0.60', 'Danceability 0.50–0.70', 'Velvety'],
    tagsVi: ['Năng lượng 0.40–0.60', 'Khả năng nhảy 0.50–0.70', 'Nhung mịn'],
  },
  ...
  // ── Category 4: Deep Chocolate Groove ────────────────────────────────────
  {
    ...
    descriptionVi: 'Espresso và chocolate — đậm đà, tối sâu, đầy hồn. Những bản groove trầm với bass nặng nề kéo ra từng lớp hương vị của Mocha.',
  ...
  },
  {
    ...
    descriptionVi: 'Sự an ủi thuần khiết trong một ly. Ballad piano ấm áp hay pop giao hưởng ôm ấp chiều sâu dịu dàng của chocolate nguyên chất.',
  ...
  },
  {
    ...
    descriptionVi: 'Tự thưởng, đậm đà và vui vẻ. Những bản nhạc sản xuất công phu, đầy punch phù hợp với tâm trạng thưởng thức bánh quy và chocolate.',
    tags: ['Loudness > -5 dB', 'Danceability > 0.60', 'Indulgent'],
    tagsVi: ['Độ to > -5 dB', 'Khả năng nhảy > 0.60', 'Tự thưởng'],
  },
  ...
  // ── Category 5: Bright / Tropical Groove ──────────────────────────────────
  {
    ...
    descriptionVi: 'Tươi sáng, nhiệt đới, chua ngọt và sảng khoái. Những bản nhạc hứng khởi, vui tươi với groove không thể cưỡng lại phản chiếu xoài chín và chanh dây.',
  ...
  },
  {
    ...
    descriptionVi: 'Bộ ba trái cây nổ tung vị ngọt và hương thơm. Afrobeats hay groove năng lượng cao đầy nắng hòa quyện hoàn hảo với hỗn hợp rực rỡ này.',
  ...
  },
  {
    ...
    descriptionVi: 'Sự mượt mà của cold drip xen lẫn độ tươi của trái cây. Những bản nhạc chill giai điệu với sự thăng hoa sảng khoái vọng lại hương vị cam đào ngọt.',
  ...
  // ── Category 6: Instrumental / Zen Flow ───────────────────────────────────
  {
    ...
    descriptionVi: 'Đất trời, thuần khiết, zen và cân bằng. Nhạc không lời năng lượng thấp tạo ra trạng thái flow vững chắc của một ly matcha latte mịn màng.',
  ...
  },
  {
    ...
    descriptionVi: 'Matcha gặp nước dừa — nhiệt đới và nhẹ nhàng. Ambient groove với kết cấu dịu dàng phù hợp với zen nhiệt đới thoáng đãng này.',
  ...
  },
  {
    ...
    descriptionVi: 'Matcha đậm với sữa tương phản — zen nhưng hiện diện. Nhạc không lời tập trung ở giọng thứ giữ đúng sức căng cần thiết.',
  ...
  },
  {
    ...
    descriptionVi: 'Rang xay, hạt dẻ, thật sự vững chắc. Folk acoustic mộc mạc với tần số mid ấm làm nổi bật chiều sâu rang của houjicha.',
  ...
  },
  {
    ...
    descriptionVi: 'Houjicha đậm vị hạt với lớp kem tương phản. Indie folk giọng thứ nắm bắt sự phức tạp ấm áp, nhiều lớp này.',
    tags: ['Acousticness > 0.55', 'Mode = Minor', 'Warm'],
    tagsVi: ['Acoustic > 0.55', 'Giọng thứ', 'Ấm áp'],
  },
  ...
  // ── Category 7: Cinematic Pop / Layered ───────────────────────────────────
  {
    ...
    descriptionVi: 'Ngọt và mặn tương phản tuyệt vời — được xếp lớp một cách tinh tế. Pop điện ảnh với sản xuất nhiều tầng phản chiếu từng ngụm.',
  ...
  },
  {
    ...
    descriptionVi: 'Bọt muối mịn trên nền phin đậm — tối giản nhưng đáng nhớ. Indie khí quyển với sức căng năng động giữa sáng và tối.',
  ...
  },
  {
    ...
    descriptionVi: 'Mát lạnh, mượt mà, trái cây và huyền bí. Electronic chill với vibe đêm tinh tế phù hợp với sự mượt mà tím sâu, băng lạnh.',
    tags: ['Energy 0.45–0.65', 'Instrumentalness > 0.25', 'Night Vibe'],
    tagsVi: ['Năng lượng 0.45–0.65', 'Không lời > 0.25', 'Vibe đêm'],
  },
  ...
  // ── Category 8: Floral / Delicate Acoustic ────────────────────────────────
  {
    ...
    descriptionVi: 'Nhung mịn, tinh tế và giản dị. Những bản acoustic nhẹ giữ năng lượng dịu dàng quanh sữa mịn và hương hoa lài.',
  ...
  },
  {
    ...
    descriptionVi: 'Duyên dáng và nhiều lớp — bọt sữa kem trên oolong lài thơm. Nhạc giọng trưởng với kết cấu phòng thu live cảm giác vừa vặn.',
  ...
  },
  {
    ...
    descriptionVi: 'Lạ miệng, hương hoa, vải ngọt nhẹ. Dream pop hay indie hư ảo với kết cấu acoustic nhẹ nhàng hòa quyện với trà thơm này.',
    tags: ['Acousticness > 0.50', 'Valence > 0.60', 'Ethereal'],
    tagsVi: ['Acoustic > 0.50', 'Độ tươi > 0.60', 'Hư ảo'],
  },
  ...
  // ── Category 9: Tropical / Vibrant Groove ────────────────────────────────
  {
    ...
    descriptionVi: 'Rực rỡ, sôi động và chua the. Nhạc thế giới hay tropical upbeat với năng lượng vũ điệu hòa quyện với cú đấm chanh dây táo bạo.',
  ...
  },
  {
    ...
    descriptionVi: 'Đào ngọt gặp cam the — tươi sáng và lạc quan. Indie pop giọng trưởng với năng lượng nâng đỡ phù hợp với hỗn hợp nắng ấm này.',
  ...
  },
  {
    ...
    descriptionVi: 'Nước chanh dây nguyên chất — năng lượng nhiệt đới không lọc. Groove có thể nhảy với năng lượng cao hòa quyện với cú nổ chua táo bạo.',
    tags: ['Valence > 0.65', 'Danceability > 0.60', 'Energetic'],
    tagsVi: ['Độ tươi > 0.65', 'Khả năng nhảy > 0.60', 'Năng động'],
  },
  ...
  // ── Category 10: Gentle Acoustic / Sweet Clarity ─────────────────────────
  {
    ...
    descriptionVi: 'Trà giòn với vị chua dịu — nội tâm và bình tĩnh. Acoustic wabi-sabi với giai điệu suy tư, tinh tế không phô trương.',
  ...
  },
  {
    ...
    descriptionVi: 'Chanh ngọt được mật ong ấm cân bằng — trong sáng và chân thực. Acoustic dịu dàng với tông ấm và sự rõ ràng giản dị.',
